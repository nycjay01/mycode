...
resource "azurerm_app_service" "dis-prod-cashtax2__dis-prod-ws-cashtax2-east" {
  ...
  app_service_plan_id = "/subscriptions/dc3c9354-6ca9-41a5-9559-479fbccf3217/resourceGroups/dis-prod-cashtax2/providers/Microsoft.Web/serverfarms/dis-prod-appsrv-plan-east"
}
